...
class BiodataController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect() -> route('biodata.index')
                          -> with('success','New Biodata Succesfully Created');
    ...
    public function update(Request $request, $id)
    {
        ...
        $biodata->kelas = $request->get('kelas');
        $biodata->alamat = $request->get('alamat');
        $biodata->save();
        return redirect() -> route('biodata.index')
                          -> with('success','Biodata Siswa Succesfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $biodata->delete();
        return redirect() -> route('biodata.index')
                          -> with('success','Biodata Siswa Succesfully Deleted');
    }
}
